...
- Force offline mode. This will edit the accounts file in MultiMC to force it to launch in Offline mode. This means that users will be unable to play Minecraft online and/or join any online servers. Useful in schools where students may not be allowed to play online for safeguarding reasons. See below for more information as this requires a bit of setup.
